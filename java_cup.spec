...
Source4:        %{pkg_name}-runtime-MANIFEST.MF
...
%mvn_file ':{*}' @1
%mvn_artifact %{pkg_name}:%{pkg_name}:%{version} dist/java-cup-%{pkg_version}.jar
%mvn_artifact %{pkg_name}:%{pkg_name}-runtime:%{version} dist/java-cup-%{pkg_version}-runtime.jar
